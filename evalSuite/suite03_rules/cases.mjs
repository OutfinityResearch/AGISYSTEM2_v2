...
export const steps = [
  ...
  // === PROVE: Simple rule application ===
  {
    action: 'prove',
    input_nl: 'Can Tweety fly? (Bird->canFly rule)',
    input_dsl: '@goal can Tweety Fly',
    expected_nl: 'True: Tweety can Fly'
  },

  // === PROVE: And condition - both satisfied ===
  {
    action: 'prove',
  ...
  // === PROVE: And condition - partial fails ===
  {
    action: 'prove',
  ...
  // === PROVE: Or condition - first branch ===
  {
    action: 'prove',
